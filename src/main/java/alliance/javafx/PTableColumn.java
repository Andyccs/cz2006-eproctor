...
public class PTableColumn<S, T> extends javafx.scene.control.TableColumn<S, T> {
    ...
    /**
     * Get the percentage width of table column
    ...
    /**
     * Get the percentage width of table column in double
     * @return double
     */
    ...
    /**
     * Setter for percentage width
     * @param value							New value
     * @throws IllegalArgumentException		Exception when invalid argument entered
     */
